...
For details about our team, research and publications see [metacoglab.org](metacoglab.ord). It is highly recommended that you read our key publications as soon as you join the lab, to get an idea of the type of questions that interest us and the different ways we approach them. You will find a list of key publications in the [Reading](link) section.
